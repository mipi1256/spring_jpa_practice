...
class DepartmentRespositoryTest {
   ...
   */
   ...
   void testFindDept() {
      ...
      Long id = 2L;
      // when
      Department department = departmentRespository.findById(id).orElseThrow();
      // then
   ...
   void testChangeDept() {
      ...
      Department newDept = departmentRespository.findById(1L).orElseThrow();
      ...
      Department foundDept = departmentRespository.findById(2L).orElseThrow();
   ...
   void testNPlusOneSolution() {
      // given
      List<Department> departments = departmentRespository.findAllIncludesEmployees();
